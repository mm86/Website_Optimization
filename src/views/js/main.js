...
var resizePizzas = function(size) { 
  ...
  //Moved the following variables outside for loop and replaced querySelectorAll with getElementsByClassName 
  //to bring pizza resize time to < 5ms
...
//Moved var pizzasDiv outside the for loop so the function makes only one DOM call.
...
function updatePositions() {
  ...
  //Created this variable len_items outside for loop
  var len_items = items.length;
  //Moved this variable out to reach target frame rate 60fps
  var scroll = (document.body.scrollTop / 1250);
  //Declared this variable outside for loop instead of inside
  var phase;
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //moved the declaration of variable elem outside the for loop
  var elem;
  //replaced querySelector with getElementById. Moved document.getElementById("movingPizzas1")
  // outside the for loop and assigned it to a variable movingPizzas.
  var movingPizzas = document.getElementById("movingPizzas1");
  //Changed pizza size from 200 to 48 to achieve target frame rate of 60fps
  for (var i = 0; i < 48; i++) {
